...
const SUGGESTIONS = ["KATSEYE", "Dj Xablau", "Red Hot Chili Peppers"]

export default function Home() {
  return (
    <main className="min-h-screen flex flex-col">
      <div className="absolute top-4 right-4">
        <ThemeToggle iconClassName="text-spotify" />
      </div>
          ...
          <div className="text-sm text-muted-foreground">
            <p>
              ...
              <SuggestionLinks
                ...
                hrefForSuggestion={(suggestion) => `/artist/${encodeURIComponent(suggestion)}`}
                linkClassName="hover:text-spotify"
              />
            </p>
          </div>
      ...
      {/* Footer */}
      <footer className="relative py-4 border-t border-border/50">
        <div className="flex justify-center">
          <SpotifyAttribution />
        </div>
        <a
